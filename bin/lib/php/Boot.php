...
class Boot {
	...
	public static function closure ($target, $func) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:632: characters 10-96
		if (\is_string($target)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:632: characters 31-61
			return Boot::getStaticClosure($target, $func);
		} else {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:632: characters 64-96
	...
	public static function createAnon ($data) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:563: characters 3-26
	...
	public static function divByZero ($value) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:652: characters 10-71
		if (Boot::equal($value, 0)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:652: characters 23-32
			return \NAN;
		} else if ($value < 0) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:652: characters 48-58
			return -\INF;
		} else {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:652: characters 61-70
			return \INF;
		}
	}
	...
	public static function dynamicField ($value, $field) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:577: lines 577-579
		if (\method_exists($value, $field)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:578: characters 11-32
			if (\is_string($value)) {
		...
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:580: lines 580-582
		if (\is_string($value)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:581: characters 4-51
			$value = new HxDynamicStr($value);
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:583: characters 3-36
		return $value->{$field};
	}
	...
	public static function dynamicString ($str) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:587: characters 3-47
	...
	public static function ensureLoaded ($phpClassName) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:570: characters 10-84
		if (!\class_exists($phpClassName)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:570: characters 47-84
	...
	public static function getInstanceClosure ($obj, $methodName) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:595: characters 3-73
		$result = ($obj->__hx_closureCache[$methodName] ?? null);
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:596: lines 596-598
		if ($result !== null) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:597: characters 4-17
			return $result;
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:599: lines 599-601
		if (!\method_exists($obj, $methodName) && !isset($obj->{$methodName})) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:600: characters 4-15
			return null;
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:602: characters 3-42
		$result = new HxClosure($obj, $methodName);
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:603: lines 603-605
		if (!\property_exists($obj, "__hx_closureCache")) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:604: characters 28-50
			$this1 = [];
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:604: characters 4-50
			$obj->__hx_closureCache = $this1;
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:606: characters 3-45
		$obj->__hx_closureCache[$methodName] = $result;
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:607: characters 3-16
		return $result;
	}
	...
	public static function getStaticClosure ($phpClassName, $methodName) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:614: characters 3-80
		$result = (Boot::$staticClosures[$phpClassName][$methodName] ?? null);
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:615: lines 615-617
		if ($result !== null) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:616: characters 4-17
			return $result;
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:618: characters 3-51
		$result = new HxClosure($phpClassName, $methodName);
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:619: lines 619-621
		if (!\array_key_exists($phpClassName, Boot::$staticClosures)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:620: characters 35-57
			$this1 = [];
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:620: characters 4-57
			Boot::$staticClosures[$phpClassName] = $this1;
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:622: characters 3-52
		Boot::$staticClosures[$phpClassName][$methodName] = $result;
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:623: characters 3-16
		return $result;
	}
	...
	public static function unsafeOrd ($s) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:639: characters 3-31
		$code = \ord($s[0]);
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:640: lines 640-648
		if ($code < 192) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:641: characters 4-15
			return $code;
		} else if ($code < 224) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:643: characters 4-57
			return (($code - 192) << 6) + \ord($s[1]) - 128;
		} else if ($code < 240) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:645: characters 4-93
			return (($code - 224) << 12) + ((\ord($s[1]) - 128) << 6) + \ord($s[2]) - 128;
		} else {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:647: characters 4-129
